...
static PROGMEM const uint16_t alphafonttable[] =  
{
	0b0000000000000001,
	0b0000000000000010,
	0b0000000000000100,
...
void Adafruit_24bargraph::setBar(uint8_t bar, uint8_t color) 
{
	...
	{	// Turn on red LED.
		displaybuffer[c] |= 1<<(a);
		// Turn off green LED.
		displaybuffer[c] &= ~(1<<(a+8));
	} 
	else if (color == LED_YELLOW) 
	{	// Turn on red and green LED.
		displaybuffer[c] |= 1<<(a) | 1<<(a+8);
	} 
...
Adafruit_8x16matrix::Adafruit_8x16matrix(void) 
{
}
...
Adafruit_8x16minimatrix::Adafruit_8x16minimatrix(void)
{
}
